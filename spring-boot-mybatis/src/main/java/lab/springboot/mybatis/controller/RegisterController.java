...
import lab.springboot.mybatis.param.RegisterParam;
...
public class RegisterController extends BaseController {
	...
	@ResponseBody
	public ResultResponse<String> register(HttpServletRequest request, @ApiParam("{\"userName\":\"min\",\"password\":\"111111\"}") @ModelAttribute RegisterParam param) {
		try {
